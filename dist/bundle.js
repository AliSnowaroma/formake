import React, { Component, useCallback, useMemo, useState, useEffect, isValidElement, PureComponent } from 'react';
import { Input as Input$1, Checkbox as Checkbox$1, Radio as Radio$1, Rate as Rate$1, DatePicker as DatePicker$1, Select as Select$1, Switch as Switch$1, message, Upload as Upload$1, Button, TimePicker as TimePicker$1, Progress as Progress$1, Row, Col, Slider, InputNumber as InputNumber$1, Popover, Tabs, Form, Space } from 'antd';
...
function catchError(Com) {
  var NewCom = /*#__PURE__*/function (_Component) {
    _inherits$8(NewCom, _Component);
    var _super = _createSuper(NewCom);
    function NewCom(props) {
      var _this;
      _classCallCheck$8(this, NewCom);
    ...
    _createClass$6(NewCom, [{
      ...
      value: function render() {
        ...
        return !error ? /*#__PURE__*/React.createElement(Com, this.props) : /*#__PURE__*/React.createElement("div", {
          style: {
            color: 'red'
          }
        }, "\u8868\u5355\u9879\u914D\u7F6E\u9519\u8BEF");
...
var transformObjectToMap = function transformObjectToMap(arr, key, value) {
  ...
  arr.forEach(function (item) {
    return targetMap.set(item[key], catchError(item[value]));
  });
  return targetMap;
};
...
var EventCenter = /*#__PURE__*/function () {
  function EventCenter() {
    _classCallCheck$8(this, EventCenter);
    this.listeners = [];
  }
  _createClass$6(EventCenter, [{
    key: "subscribe",
...
function Input(props) {
  ...
  return /*#__PURE__*/React.createElement(Input$1, _extends$b({}, rest, {
...
function Radio(props) {
  ...
  return /*#__PURE__*/React.createElement(Radio$1.Group, _extends$b({}, rest, {
    disabled: disabled,
    options: options,
...
function Textarea(props) {
  ...
  return /*#__PURE__*/React.createElement(Input$1.TextArea, _extends$b({
    placeholder: placeholder,
    disabled: disabled,
    value: value,
    onChange: onChange
...
function Rate(props) {
  ...
  return /*#__PURE__*/React.createElement(Rate$1, _extends$b({}, rest, {
    disabled: disabled
  }));
}
...
var _excluded$a = ["picker", "onChange", "value", "showTime"];
...
function DatePicker(props) {
  ...
  return /*#__PURE__*/React.createElement(DatePicker$1, _extends$b({
...
var _excluded$9 = ["placeholder", "disabled", "picker", "value", "onChange", "format", "showTime"];
...
function RangePicker(props) {
  ...
  return /*#__PURE__*/React.createElement(AntdRangePicker, _extends$b({}, rest, {
    placeholder: placeholder,
    disabled: disabled,
...
function Select(props) {
  ...
  return /*#__PURE__*/React.createElement(Select$1, _extends$b({}, rest, {
    placeholder: placeholder,
    disabled: disabled,
    options: options,
    value: value,
...
function Switch(props) {
  ...
  return /*#__PURE__*/React.createElement(Switch$1, _extends$b({}, rest, {
    checked: value,
    disabled: disabled
  }));
}
...
function Upload(props) {
  ...
  return /*#__PURE__*/React.createElement(Upload$1, _extends$b({
    disabled: disabled,
    action: action,
    listType: listType
  }, rest, {
...
function TimePicker(props) {
  ...
  return /*#__PURE__*/React.createElement(TimePicker$1, _extends$b({
...
function Progress(props) {
  ...
  return /*#__PURE__*/React.createElement(Progress$1, _extends$b({
    percent: value
  }, rest));
}
...
function InputNumber(props) {
  ...
  return /*#__PURE__*/React.createElement(InputNumber$1, _extends$b({
    value: value
  }, rest, {
    max: max,
    min: min,
...
function isString(value) {
  return typeof value == 'string' || !isArray$c(value) && isObjectLike$9(value) && baseGetTag$7(value) == stringTag$5;
}
...
function baseIsArguments$2(value) {
  return isObjectLike$8(value) && baseGetTag$6(value) == argsTag$5;
}
...
/** Built-in value references. */
var propertyIsEnumerable$2 = objectProto$p.propertyIsEnumerable;
...
var isArguments$4 = baseIsArguments$1(function () {
  ...
  return isObjectLike$7(value) && hasOwnProperty$l.call(value, 'callee') && !propertyIsEnumerable$2.call(value, 'callee');
};
...
typedArrayTags$1[argsTag$4] = typedArrayTags$1[arrayTag$3] = typedArrayTags$1[arrayBufferTag$4] = typedArrayTags$1[boolTag$4] = typedArrayTags$1[dataViewTag$5] = typedArrayTags$1[dateTag$4] = typedArrayTags$1[errorTag$3] = typedArrayTags$1[funcTag$4] = typedArrayTags$1[mapTag$6] = typedArrayTags$1[numberTag$4] = typedArrayTags$1[objectTag$6] = typedArrayTags$1[regexpTag$4] = typedArrayTags$1[setTag$6] = typedArrayTags$1[stringTag$4] = typedArrayTags$1[weakMapTag$3] = false;
...
function isPlainObject$1(value) {
  if (!isObjectLike$5(value) || baseGetTag$3(value) != objectTag$5) {
    return false;
  }
...
var reIsNative$1 = RegExp('^' + funcToString$3.call(hasOwnProperty$h).replace(reRegExpChar$1, '\\$&').replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, '$1.*?') + '$');
...
function hashHas$2(key) {
  var data = this.__data__;
  return nativeCreate$3 ? data[key] !== undefined : hasOwnProperty$f.call(data, key);
}
...
/* Built-in method references that are verified to be native. */
var Promise$2 = getNative$4(root$4, 'Promise');
...
/* Built-in method references that are verified to be native. */
var Set$1 = getNative$3(root$3, 'Set');
var _Set = Set$1;
...
/* Built-in method references that are verified to be native. */
var WeakMap$1 = getNative$2(root$2, 'WeakMap');
...
if (DataView && getTag$4(new DataView(new ArrayBuffer(1))) != dataViewTag$3 || Map$3 && getTag$4(new Map$3()) != mapTag$4 || Promise$1 && getTag$4(Promise$1.resolve()) != promiseTag || Set && getTag$4(new Set()) != setTag$4 || WeakMap && getTag$4(new WeakMap()) != weakMapTag$2) {
...
function isSymbol$4(value) {
  return _typeof$1(value) == 'symbol' || isObjectLike$3(value) && baseGetTag$1(value) == symbolTag$3;
}
...
function assignValue$3(object, key, value) {
  var objValue = object[key];
  if (!(hasOwnProperty$c.call(object, key) && eq$1(objValue, value)) || value === undefined && !(key in object)) {
...
function baseIsMap$1(value) {
  return isObjectLike$2(value) && getTag$2(value) == mapTag$2;
}
...
function baseClone$1(value, bitmask, customizer, key, object, stack) {
  ...
  var keysFunc = isFull ? isFlat ? getAllKeysIn : getAllKeys : isFlat ? keysIn$1 : keys$1;
  ...
  activeNames.map(function (name) {
    ...
    if (toMerge) {
      (0, _forOwn3$1["default"])(toMerge, function (value, key) {
        ...
        styles[key] = _extends$a({}, styles[key], toMerge[key]);
      });
    }
    return name;
  });
...
var autoprefix = autoprefix$1.autoprefix = function autoprefix(elements) {
  ...
  (0, _forOwn3["default"])(elements, function (styles, element) {
    ...
    (0, _forOwn3["default"])(styles, function (value, key) {
      ...
      if (transform) {
        expanded = _extends$9({}, expanded, transform(value));
      } else {
        expanded[key] = value;
      }
    });
...
var hover = hover$1.hover = function hover(Component) {
  ...
  return function (_React$Component) {
    ...
    function Hover() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn$7(this, (_ref = Hover.__proto__ || Object.getPrototypeOf(Hover)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
        hover: false
        ...
        return _react2$1["default"].createElement(Span, {
          onMouseOver: _this.handleMouseOver,
          onMouseOut: _this.handleMouseOut
        }, _react2$1["default"].createElement(Component, _extends$8({}, _this.props, _this.state)));
...
var active = active$1.active = function active(Component) {
  ...
  return function (_React$Component) {
    ...
    function Active() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn$6(this, (_ref = Active.__proto__ || Object.getPrototypeOf(Active)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
        active: false
        ...
        }, _react2["default"].createElement(Component, _extends$7({}, _this.props, _this.state)));
...
var Checkboard = function Checkboard(_ref) {
  ...
  return /*#__PURE__*/isValidElement(children) ? /*#__PURE__*/React.cloneElement(children, _extends$6({}, children.props, {
    style: _extends$6({}, children.props.style, styles.grid)
...
var Alpha = function (_ref) {
  ...
  function Alpha() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn$5(this, (_ref2 = Alpha.__proto__ || Object.getPrototypeOf(Alpha)).call.apply(_ref2, [this].concat(args))), _this), _this.handleChange = function (e) {
  ...
  _createClass$5(Alpha, [{
    ...
    value: function render() {
      ...
      var styles = _default({
        ...
        'overwrite': _extends$5({}, this.props.style)
      }, {
  ...
  var ColorPicker = function (_ref) {
    ...
    _createClass$1(ColorPicker, [{
      ...
      value: function render() {
        ...
        return /*#__PURE__*/React.createElement(Picker, _extends$4({}, this.props, this.state, {
          onChange: this.handleChange
        }, optionalEvents));
      }
    }], [{
    ...
    _createClass(Focus, [{
      ...
      value: function render() {
        return /*#__PURE__*/React.createElement(Span, {
          ...
          onBlur: this.handleBlur
        }, /*#__PURE__*/React.createElement(Component, _extends$3({}, this.props, this.state)));
      }
    }]);
    return Focus;
  }(React.Component);
...
var SketchPresetColors = function SketchPresetColors(_ref) {
  ...
  return /*#__PURE__*/React.createElement('div', {
    ...
    }, /*#__PURE__*/React.createElement(Swatch$1, _extends$1({}, c, {
      style: styles.swatch,
      onClick: handleClick,
...
function RowContainer$1(props) {
  ...
  return /*#__PURE__*/React.createElement(Row, {
    ...
    var _formItemConfig$rowCo = formItemConfig.rowCol,
      ...
      rest = _objectWithoutProperties(formItemConfig, _excluded$2);
    return /*#__PURE__*/React.createElement(Col, _extends$b({
...
function TabContainer(props) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    formItemConfig.tabTitle;
      var rest = _objectWithoutProperties(formItemConfig, _excluded$1);
...
var realMarkTypes = FormItemList.map(function (item) {
  return item.marktype;
});
...
function GenerateFormItem(props) {
  var formItemConfig = props.formItemConfig,
    ...
    hidden = props.hidden,
    listName = props.listName,
    onFormItemClick = props.onFormItemClick,
    activeId = props.activeId;
  ...
  var onInnerFormItemClick = useCallback(function (e, item) {
    e.stopPropagation();
    onFormItemClick && onFormItemClick(item);
  }, []);
  var formItemCfg = generateObjFromKeys(formItemConfig, formItemPropsList);
  var comCfg = filterObj(formItemConfig, [].concat(_toConsumableArray(formItemPropsList), ['eventConfig', 'id']));
  if (listName !== undefined && marktype === 'listContainer') {
    throw new Error('listContainer类型不支持嵌套listContainer类型');
  }
  var id = formItemConfig.id;
  var dataIdObj = id ? {
    'data-id': id
  } : {};
  var activeClass = id && activeId && id === activeId ? 'formake-active-form-item' : '';
  if (containerMarkTypes.includes(marktype)) {
    return /*#__PURE__*/React.createElement(FormItem, _extends$b({}, formItemCfg, dataIdObj, {
      hidden: hidden,
      rules: rules,
      style: {
        marginBottom: 0
      ...
      onClick: function onClick(e) {
        onInnerFormItemClick(e, formItemConfig);
      },
      className: "".concat(activeClass)
    }), /*#__PURE__*/React.createElement(DynamicFormItem, _extends$b({}, comCfg, {
      isEditor: isEditor,
      formItemPropsList: formItemPropsList,
      disabled: disabled,
      listName: listName,
  ...
  return DynamicFormItem ? /*#__PURE__*/React.createElement(FormItem, _extends$b({}, formItemCfg, {
    ...
    disabled: disabled
  }))) : /*#__PURE__*/React.createElement(FormItem, _extends$b({}, formItemCfg, {
    style: {
      color: 'red'
    }
...
var _excluded = ["isEditor", "children", "activeId"];
var GenerateForm = /*#__PURE__*/function (_Component) {
  _inherits$8(GenerateForm, _Component);
  var _super = _createSuper(GenerateForm);
  function GenerateForm(props) {
    var _this;
    _classCallCheck$8(this, GenerateForm);
    _this = _super.call(this, props);
  ...
  _createClass$6(GenerateForm, [{
    ...
    value: function updateFormData(values) {
      ...
      function filterFields(activeFormData, hideFields) {
        var newFromData = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(React.Fragment, null, !formError ? /*#__PURE__*/React.createElement("div", {
        className: "".concat(this.props.className, " formake-dynamic-form")
      }, /*#__PURE__*/React.createElement(Form, _extends$b({
        ...
        activeId: activeId
      }), children)), this.props.footer) : /*#__PURE__*/React.createElement("div", {
        style: {
          color: 'red'
        },
        className: "".concat(this.props.className, " formake-dynamic-form")
      }, /*#__PURE__*/React.createElement("h4", null, "\u8868\u5355\u914D\u7F6E\u9519\u8BEF")));
    }
  }], [{
    key: "getDerivedStateFromProps",
    value: function getDerivedStateFromProps(props, state) {
...
export { GenerateForm, GenerateFormItems, allMarkTypes, containerMarkTypes, GenerateForm as default, realMarkTypes, useWatchForm };
